...
public class mavitopolusturucu : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject go = Instantiate(mavitop, new Vector3(Random.Range(-2.4f, 2.4f), 6, 0), Quaternion.Euler(0,0,0)) as GameObject;
